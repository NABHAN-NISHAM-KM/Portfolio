...
import { FaTrophy, FaCrown, FaChartLine, FaCode, FaBullhorn, FaKey, FaMobileAlt, FaGamepad, FaHeadset } from "react-icons/fa";

const services = [
  {
    icon: <FaTrophy className="mx-auto text-5xl text-[#63b2fd] mb-4" />,
    title: "Web Design",
    desc: "Modern, responsive, and user-friendly web design for your business or personal brand.",
  },
  {
    icon: <FaCode className="mx-auto text-5xl text-[#63b2fd] mb-4" />,
    title: "Development",
    desc: "Full-stack development using modern frameworks for scalable, robust solutions.",
  },
  {
    icon: <FaMobileAlt className="mx-auto text-5xl text-[#63b2fd] mb-4" />,
    title: "Mobile Application",
    desc: "Cross-platform mobile app development for Android and iOS with a focus on performance and UX.",
  },
  {
    icon: <FaGamepad className="mx-auto text-5xl text-[#63b2fd] mb-4" />,
    title: "Game Development",
    desc: "Engaging and interactive game development for web and mobile platforms.",
  },
  {
    icon: <FaHeadset className="mx-auto text-5xl text-[#63b2fd] mb-4" />,
...
const Services = () => {
  return (
    <section id="services" className="w-full min-h-screen bg-white/90 py-16 pb-32 md:pb-16">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-2">
          <h2 className="text-4xl font-extrabold text-[#22223b] mb-2">What I Offer</h2>
